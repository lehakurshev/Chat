...
// // Listen on every connection for chat1
// io.of('/chat1').on('connection', (socket) => {
//   console.log('New user connected to chat1');
//   // Default username
//   socket.username = "Anonymous";
...
//   socket.emit('chat_history', { history: fs.readFileSync('chatHistory1.txt', 'utf8').split('\n') });
...
//     // Save message to file
//     fs.appendFileSync('chatHistory1.txt', `${socket.username.substr(0, 20)}: ${data.message.substr(0, 50)}\n`);
//   });
...
// // Listen on every connection for chat2
// io.of('/chat2').on('connection', (socket) => {
//   console.log('New user connected to chat2');
//   // Default username
//   socket.username = "Anonymous";
...
//   socket.emit('chat_history', { history: fs.readFileSync('chatHistory2.txt', 'utf8').split('\n') });
...
//     // Save message to file
//     fs.appendFileSync('chatHistory2.txt', `${socket.username.substr(0, 20)}: ${data.message.substr(0, 50)}\n`);
//   });
